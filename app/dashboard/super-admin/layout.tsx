        ...
        <div className="min-h-screen bg-gray-50 font-primary flex">
            ...
            <aside className="w-72 bg-gradient-to-b from-brand-950 via-brand-900 to-brand-950 text-white fixed h-full z-10 flex flex-col border-r border-brand-800/30">
                ...
                <nav className="flex-1 px-3 py-2 space-y-0.5 overflow-y-auto custom-scrollbar">
                    ...
                    <SidebarItem icon={SchoolIcon} label="Tenants (Schools)" href="/dashboard/super-admin/tenants" active={pathname.startsWith('/dashboard/super-admin/tenants')} />
                    <SidebarItem icon={Wallet} label="Financials" href="/dashboard/super-admin/financials" active={pathname.startsWith('/dashboard/super-admin/financials')} />
                    <SidebarItem icon={CreditCard} label="Plans & Pricing" href="/dashboard/super-admin/plans" active={pathname.startsWith('/dashboard/super-admin/plans')} />
                    <SidebarItem icon={Grid} label="Modules Library" href="/dashboard/super-admin/modules" active={pathname.startsWith('/dashboard/super-admin/modules')} />

                    <SidebarGroup label="Communication" />
                    <SidebarItem icon={Mail} label="Email Templates" href="/dashboard/super-admin/templates" active={pathname.startsWith('/dashboard/super-admin/templates')} />
                    <SidebarItem icon={ScrollText} label="Delivery Logs" href="/dashboard/super-admin/logs" active={pathname.startsWith('/dashboard/super-admin/logs')} />
                    <SidebarItem icon={Megaphone} label="Email Marketing" href="/dashboard/super-admin/email-marketing" active={pathname.startsWith('/dashboard/super-admin/email-marketing')} />
                    <SidebarItem icon={Radio} label="Broadcasts" href="/dashboard/super-admin/broadcasts" active={pathname.startsWith('/dashboard/super-admin/broadcasts')} />

                    <SidebarGroup label="Advanced" />
                    <SidebarItem icon={Shield} label="Governance" href="/dashboard/super-admin/governance" active={pathname.startsWith('/dashboard/super-admin/governance')} />
                    <SidebarItem icon={Rocket} label="Demo Requests" href="/dashboard/super-admin/demo-requests" active={pathname.startsWith('/dashboard/super-admin/demo-requests')} />
                    <SidebarItem icon={MessageSquare} label="Support Tickets" href="/dashboard/super-admin/support" active={pathname.startsWith('/dashboard/super-admin/support')} />
                    <SidebarItem icon={Settings} label="Platform Settings" href="/dashboard/super-admin/settings" active={pathname.startsWith('/dashboard/super-admin/settings')} />
                </nav>
                                                ...
                                                <div>
                                                    ...
                                                    <div className="space-y-1">
                                                        {searchResults.schools.map((s: any) => (
                                                            <Link key={s.id} href="/dashboard/super-admin/tenants" onClick={() => { setIsSearchOpen(false); setSearchQuery(''); }}
