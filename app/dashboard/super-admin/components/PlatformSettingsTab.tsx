...
export function PlatformSettingsTab({ settings }: { settings: any }) {
  ...
  if (!editedSettings)
    return (
      <div className="p-8 text-center text-gray-500 font-bold uppercase tracking-widest animate-pulse">
    ...
    <div className="max-w-4xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div>
        ...
        <p className="text-gray-500 font-medium text-sm">
          Configure global payment methods, Paystack API keys, and system-wide defaults.
        </p>
      </div>
      <form onSubmit={handleSave} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditedSettings({ ...editedSettings, paystack_public_key: e.target.value })
                  }
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditedSettings({ ...editedSettings, paystack_secret_key: e.target.value })
                  }
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm font-mono focus:ring-2 focus:ring-brand-500 transition-all outline-none"
        ...
        <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { key: 'bank_name', label: 'Bank Name', ph: 'e.g. GTBank' },
              { key: 'account_number', label: 'Account Number', ph: '0123456789' },
              ...
              <div key={f.key} className="space-y-2">
                ...
                <input
                  value={editedSettings[f.key] || ''}
                  onChange={(e) =>
                    setEditedSettings({ ...editedSettings, [f.key]: e.target.value })
                  }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditedSettings({ ...editedSettings, email_from: e.target.value })
                  }
                  className="w-full bg-gray-50 border-0 rounded-xl px-4 py-3 text-sm font-bold focus:ring-2 focus:ring-brand-600 transition-all outline-none"
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditedSettings({ ...editedSettings, email_from_name: e.target.value })
                  }
                  className="w-full bg-gray-50 border-0 rounded-xl px-4 py-3 text-sm font-bold focus:ring-2 focus:ring-brand-600 transition-all outline-none"
            ...
            {editedSettings.email_provider === 'brevo_api' ? (
              <div className="space-y-2 bg-slate-50 p-6 rounded-2xl border border-dashed border-gray-200">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditedSettings({ ...editedSettings, email_api_key: e.target.value })
                  }
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setEditedSettings({ ...editedSettings, email_host: e.target.value })
                      }
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setEditedSettings({ ...editedSettings, email_user: e.target.value })
                      }
                      className="w-full bg-white border-0 rounded-xl px-4 py-3 text-sm font-bold focus:ring-2 focus:ring-brand-600 transition-all outline-none"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setEditedSettings({ ...editedSettings, email_password: e.target.value })
                      }
                      className="w-full bg-white border-0 rounded-xl px-4 py-3 text-sm font-bold focus:ring-2 focus:ring-brand-600 transition-all outline-none"
                    />
                  </div>
                  ...
                  {[
                    ...
                    >
                      <div className="relative">
                        <input
                          type="checkbox"
                          checked={editedSettings[toggle.key]}
                          onChange={(e) =>
                            setEditedSettings({ ...editedSettings, [toggle.key]: e.target.checked })
                          }
                          className="sr-only"
                        />
                        <div
                          className={`w-10 h-6 bg-gray-200 rounded-full transition-colors group-hover:bg-gray-300 ${editedSettings[toggle.key] ? 'bg-brand-600 group-hover:bg-brand-700' : ''}`}
                        />
                        <div
                          className={`absolute left-1 top-1 w-4 h-4 bg-white rounded-full transition-transform ${editedSettings[toggle.key] ? 'translate-x-4' : ''}`}
                        />
                      </div>
                ...
                {editedSettings.ai_provider === 'gemini' ? (
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setEditedSettings({ ...editedSettings, gemini_api_key: e.target.value })
                      }
                      className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm font-mono focus:ring-2 focus:ring-brand-500 transition-all outline-none"
                      placeholder="AIzaSy..."
                    />
                  ...
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      <select
                        value={editedSettings.openrouter_model || 'google/gemini-2.0-flash-001'}
                        onChange={(e) =>
