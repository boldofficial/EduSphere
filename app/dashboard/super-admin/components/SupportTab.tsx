              ...
              <div className="flex-1 overflow-y-auto p-8 space-y-8 custom-scrollbar pb-32">
                {selectedTicket.responses.length === 0 ? (
                  ...
                  selectedTicket.responses.map((resp: any) => (
                    <div
                      key={resp.id}
                      className={`flex ${resp.is_admin_response ? 'justify-end' : 'justify-start'}`}
                    >
              ...
              <form onSubmit={handleCreateTicket} className="space-y-8">
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  <Button
                    ...
                    className="flex-1 rounded-[24px] h-16 font-black shadow-xl shadow-brand-900/10 active:scale-95 transition-all bg-brand-600"
                  >
