...
export function SchoolEditModal({
  ...
  const [formData, setFormData] = useState({
    ...
    subscription_end_date: school?.subscription?.end_date
      ? new Date(school.subscription.end_date).toISOString().split('T')[0]
      : '',
  });
        ...
        <div className="p-8 border-b border-gray-100 flex justify-between items-center bg-gray-50/50 shrink-0">
          <div>
            ...
            <p className="text-sm text-gray-500 font-medium">
              Update core administrative information for {school?.name}.
            </p>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                />
                <div className="absolute right-4 top-1/2 -translate-y-1/2 text-xs font-black text-gray-300 uppercase">
                  .{ROOT_DOMAIN}
                </div>
              </div>
            </div>
