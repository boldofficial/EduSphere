...
import { safeJsonParse, withRateLimit, errorResponse, unauthorizedResponse } from '@/lib/api-utils';
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Upload to R2
    const url = await uploadBase64ToR2(base64Data, key, contentType || 'image/jpeg');
