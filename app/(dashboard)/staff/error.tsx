      ...
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-600">
            We encountered a problem while trying to load the staff directory. This usually happens
            due to a temporary connection issue.
          </p>
        </div>

        <div className="flex flex-col gap-3">
          <Button onClick={reset} className="w-full bg-brand-600 hover:bg-brand-700 py-6 text-lg">
