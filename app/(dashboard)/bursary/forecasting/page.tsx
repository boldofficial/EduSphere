...
import { useAcademicTerms, useRevenueSummary, useRevenueChart } from '@/lib/hooks/use-bursary';
    ...
    <div className="p-6 space-y-8 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 font-medium">
            Predictive financial insights for {currentTerm?.name || 'Current Term'}
          </p>
        </div>
        ...
        <div className="flex items-center gap-2 bg-white p-1 rounded-xl shadow-sm border border-gray-100">
          ...
          >
            ...
            {(!terms || terms.length === 0) && <option>No Academic Terms Defined</option>}
          </select>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="relative overflow-hidden border-none shadow-xl bg-gradient-to-br from-indigo-600 to-blue-800 text-white p-6">
          ...
          <div className="flex items-center justify-between relative z-10 gap-3">
            <div className="min-w-0 flex-1">
              <p className="text-blue-100/70 text-xs font-bold uppercase tracking-wider truncate">
                Expected Revenue
              </p>
        ...
        <Card className="relative overflow-hidden border-none shadow-xl bg-gradient-to-br from-amber-500 to-orange-700 text-white p-6">
          ...
          <div className="flex items-center justify-between relative z-10 gap-3">
            <div className="min-w-0 flex-1">
              <p className="text-amber-50/70 text-xs font-bold uppercase tracking-wider truncate">
                Outstanding Feed
              </p>
              <p className="text-2xl font-black mt-1 leading-none">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
            <div>
              ...
              <p className="text-sm text-gray-400 font-medium italic">
                Tracking collection pace vs expected baseline
              </p>
            </div>
                ...
                >
                  ...
                  <Tooltip
                    ...
                    formatter={(val: string | number | undefined) => [
                      Utils.formatCurrency(Number(val ?? 0)),
                      '',
                    ]}
                  />
                  <Area
        ...
        <div className="space-y-6">
          <Card className="p-8 shadow-sm border-gray-100 bg-white h-full relative overflow-hidden">
            ...
            <h3 className="text-xl font-black text-gray-900 uppercase tracking-tighter mb-6 underline decoration-brand-500/30 underline-offset-8">
              Insights
            </h3>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm font-black text-blue-600">
                    {summary
                      ? Math.min(100, (summary.days_elapsed / summary.days_total) * 100).toFixed(0)
                      : 0}
                    %
                  </span>
                </div>
                <div className="h-3 w-full bg-gray-50 rounded-full overflow-hidden border border-gray-100 p-0.5">
                  <div
                    ...
                    style={{
                      width: `${summary ? (summary.days_elapsed / summary.days_total) * 100 : 0}%`,
                    }}
                  />
                </div>
              ...
              <div className="pt-6 border-t border-gray-100">
                <div className="bg-brand-50/50 p-4 rounded-2xl border border-brand-100">
                  ...
                  <p className="text-xs text-brand-800/80 font-medium leading-relaxed">
                    ...
                    {summary && summary.days_elapsed > 0
                      ? (summary.collected / summary.days_elapsed).toLocaleString()
                      : '0'}
                    /day), collection is trending{' '}
                    {summary && summary.forecast >= summary.expected ? 'above' : 'below'} initial
                    targets.
                    {summary &&
                      summary.outstanding > 0 &&
                      ` Actionable arrears of ${Utils.formatCurrency(summary.outstanding)} remain.`}
                  </p>
                </div>
              </div>
            </div>
