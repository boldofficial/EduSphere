        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12">
          ...
          <div className="prose prose-brand max-w-none text-gray-600">
            <p className="lead text-xl text-gray-700 mb-8">
              Welcome to the Registra website and portal. By accessing or using our services, you
            ...
            <p className="mb-6">
              By using our website, portal, and related services, you signify your acceptance of
            ...
            <p className="mb-6">
              ...
              property of Registra or its content suppliers and is protected by intellectual
            ...
            <p className="mb-6">
              If you are issued a portal account, you are responsible for maintaining the
            ...
            <p className="mb-6">
              Registra shall not be liable for any indirect, incidental, special, or consequential
