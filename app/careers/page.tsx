      ...
      <main className="flex-grow pt-10">
        ...
        <div className="bg-brand-900 text-white py-24 px-4 text-center">
          <div className="max-w-4xl mx-auto space-y-6">
            <span className="inline-block py-2 px-4 bg-white/10 rounded-full text-accent-400 font-bold text-sm tracking-widest uppercase mb-4">
              Join our team
            </span>
            <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-8">
              Build the future of <br />
              <span className="text-accent-500">Education</span>
            </h1>
            <p className="text-xl text-brand-100 max-w-2xl mx-auto leading-relaxed">
              We are on a mission to digitize every school in Africa. If you are passionate about
              impact, engineering, and education, you belong here.
            </p>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-500 max-w-2xl mx-auto">
                We offer more than just a job. We offer a chance to make a tangible difference in
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="mt-12 text-center text-gray-500">
              <p>
                Don&apos;t see your role?{' '}
                <a
                  href="mailto:careers@myregistra.net"
