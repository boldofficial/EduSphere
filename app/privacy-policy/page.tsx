        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12">
          ...
          <div className="prose prose-brand max-w-none text-gray-600">
            <p className="lead text-xl text-gray-700 mb-8">
              At Registra, we are committed to protecting the privacy and security of our students,
              parents, and staff. This Privacy Policy outlines how we collect, use, and safeguard
            ...
            <p>
              We collect various types of information to provide educational services, including:
            </p>
            <ul className="list-disc pl-5 space-y-2 mb-6">
              <li>
                <strong>Student Information:</strong> Names, dates of birth, academic records,
                attendance, and medical information.
              </li>
              <li>
                <strong>Parent/Guardian Information:</strong> Names, contact details, and payment
                information.
              </li>
              <li>
                <strong>Staff Information:</strong> Employment history, qualifications, and contact
                details.
              </li>
              <li>
                <strong>Digital Data:</strong> Information collected via our website and portal,
            ...
            <p>
              Your information is used for legitimate educational and administrative purposes, such
              as:
            </p>
            <ul className="list-disc pl-5 space-y-2 mb-6">
            ...
            <p className="mb-6">
              ...
              providers (e.g., payment processors, educational software) who assist us in our
              operations, strictly under confidentiality agreements. We may also disclose
            ...
            <p className="mb-6">
              ...
              alteration, or disclosure. This includes secure servers, encryption, and strict access
              controls.
            </p>
            ...
            <p className="mb-6">
              ...
              information, subject to legal and educational record-retention requirements. Please
              contact the school administration for any such requests.
            </p>
            ...
            <p>
              ...
              <a
                href="mailto:info@myregistra.net"
