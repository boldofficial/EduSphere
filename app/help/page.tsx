        ...
        <div className="bg-white border-t border-gray-100 py-16">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <div className="flex justify-center gap-4">
              <a
                href="mailto:support@myregistra.net"
                className="px-8 py-3 bg-brand-600 text-white font-bold rounded-xl hover:bg-brand-700 transition-colors"
              >
                Email Support
              </a>
              <a
...
function HelpCard({ icon: Icon, title, description, link }: any) {
  return (
    <a
      href={link}
      className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100 hover:-translate-y-1 transition-transform group"
    >
