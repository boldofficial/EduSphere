      ...
      <main className="flex-grow pt-10">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-brand-100 max-w-2xl leading-relaxed">
                Discover how innovative schools across Africa are transforming their operations and
                academic results with Registra.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="py-24 px-4 bg-white text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <a
              href="/onboarding"
              className="inline-block px-10 py-5 bg-brand-600 text-white font-black text-lg rounded-2xl shadow-xl hover:scale-105 transition-transform"
            >
              Join Registra Today
            </a>
          </div>
