...
class FeeItemSerializer(serializers.ModelSerializer):
    category = serializers.PrimaryKeyRelatedField(queryset=FeeCategory.objects.none(), required=False, allow_null=True)
    ...
    def create(self, validated_data):
        ...
        if name and not validated_data.get("category"):
            category, _ = FeeCategory.objects.get_or_create(
                name=name, school=school, defaults={"is_optional": is_optional}
            )
