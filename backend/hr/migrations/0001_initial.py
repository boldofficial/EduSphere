...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'abstract': False,
                'indexes': [models.Index(fields=['school', 'created_at'], name='hr_staffsal_school__de4841_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'abstract': False,
                'indexes': [models.Index(fields=['school', 'created_at'], name='hr_salaryde_school__9a58f1_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'abstract': False,
                'indexes': [models.Index(fields=['school', 'created_at'], name='hr_salaryal_school__4ea711_idx')],
            },
        ),
        migrations.CreateModel(
            name='PayrollEntry',
            fields=[
                ...
                ('payroll', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='entries', to='hr.payroll')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_related', to='schools.school')),
