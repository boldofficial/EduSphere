...
class ReportCard(TenantModel):
    ...
    class Meta:
        ...
        constraints = [models.UniqueConstraint(fields=["student", "session", "term"], name="unique_report_per_term")]
...
class TimetableEntry(TenantModel):
    ...
    )  # Can be different from main subject teacher
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=["timetable", "day_of_week", "period"], name="unique_class_period_slot"),
            models.UniqueConstraint(fields=["teacher", "day_of_week", "period"], name="unique_teacher_period_slot"),
        ]
