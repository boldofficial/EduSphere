...
urlpatterns = [
    ...
    path("payment-settings/", SchoolPaymentSettingsView.as_view(), name="school-payment-settings"),
    path("public/payment-options/", PublicSchoolPaymentOptionsView.as_view(), name="public-payment-options"),
