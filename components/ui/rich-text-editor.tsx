...
export function RichTextEditor({
  ...
  return (
    <div
      className={`border rounded-md bg-white overflow-hidden focus-within:ring-2 focus-within:ring-brand-500 focus-within:border-transparent transition-all ${className}`}
    >
      {/* Toolbar */}
