  ...
  (
    ...
    if (!items.length && !loading) {
      return renderEmpty ? (
        ...
        <div className="flex items-center justify-center h-48 text-gray-400">No items found</div>
      );
    }
    ...
    return (
      ...
      >
        ...
        {loading && loadingMore && (
          <div className="py-4 text-center text-gray-500">{loadingMore}</div>
        )}

        {!loading && hasMore && onEndReached && (
          <div className="py-4 text-center text-gray-400">Scroll for more...</div>
        )}
      </div>
    );
  }
