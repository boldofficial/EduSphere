              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-2">
                    ...
                    {editForm.ranges?.map((range, idx) => (
                      <div key={range.id || idx} className="grid grid-cols-6 gap-2 items-center">
                        ...
                        <input
                          ...
                          onChange={(e) => updateRange(idx, 'min_score', Number(e.target.value))}
                        />
                        <input
                          className="p-2 border rounded"
                          type="number"
                          value={range.max_score}
                          onChange={(e) => updateRange(idx, 'max_score', Number(e.target.value))}
                        />
                        <input
                          className="p-2 border rounded col-span-2"
                          value={range.remark}
                          onChange={(e) => updateRange(idx, 'remark', e.target.value)}
                        />
                        <div className="flex gap-2 items-center">
                          <input
                            ...
                            type="number"
                            step="0.1"
                            value={range.gpa_point}
                            onChange={(e) => updateRange(idx, 'gpa_point', Number(e.target.value))}
                          />
                          <button
                    ...
                    <Button variant="outline" size="sm" onClick={addRange} className="w-full mt-2">
                      <Plus size={14} /> Add Grade Range
                    </Button>
                  </div>
                </div>
