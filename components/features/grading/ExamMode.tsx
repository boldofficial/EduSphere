        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Input
              ...
              onChange={(e) =>
                setExamConfig({ ...examConfig, duration: parseInt(e.target.value) || 60 })
              }
            />
            ...
            <Input
              ...
              onChange={(e) =>
                setExamConfig({ ...examConfig, totalMarks: parseInt(e.target.value) || 100 })
              }
            />
            ...
            <Input
              ...
              onChange={(e) =>
                setExamConfig({ ...examConfig, passingMarks: parseInt(e.target.value) || 50 })
              }
            />
          </div>
      ...
      <Card className="p-4 bg-gradient-to-r from-red-50 to-orange-50 border-red-200">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div
              className={`p-3 rounded-full ${timeRemaining < 300 ? 'bg-red-100 animate-pulse' : 'bg-red-50'}`}
            >
              <Timer
                className={`h-6 w-6 ${timeRemaining < 300 ? 'text-red-600' : 'text-red-500'}`}
              />
            </div>
            <div>
          ...
          <div className="text-right">
            ...
            <p
              className={`text-3xl font-bold font-mono ${timeRemaining < 300 ? 'text-red-600' : 'text-gray-900'}`}
            >
