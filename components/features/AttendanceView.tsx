...
export const AttendanceView: React.FC<AttendanceViewProps> = ({
  ...
  const handleSave = () => {
    ...
    const newEntry: Types.Attendance = {
      id: existingRecord?.id || Utils.generateId(),
      date,
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500">Daily roll call management</p>
        </div>
        <Button
          onClick={handleSave}
          disabled={isLocked}
      ...
      <Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 relative">
          ...
          {activeStudents.map((s) => (
            ...
            >
              <div>
                <div className="font-bold text-gray-900">{s.names}</div>
          ...
          {activeStudents.length === 0 && (
            <p className="text-gray-500 italic col-span-3 text-center py-8">
