  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
      {stats.map((stat, i) => (
        <div
          key={i}
          className="bg-white p-3 sm:p-4 lg:p-6 rounded-xl lg:rounded-2xl shadow-sm border border-gray-100 flex items-center gap-3 lg:gap-4"
        >
            ...
            <div className="flex items-center gap-1 sm:gap-2 flex-wrap">
              ...
              {stat.trend !== null && stat.trend !== 0 && (
                ...
                >
                  ...
                  {Math.abs(stat.trend).toFixed(stat.label === 'Rank' ? 0 : 1)}
                  {stat.trendSuffix}
                </span>
              )}
            </div>
