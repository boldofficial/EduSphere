    ...
    <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-2xl lg:rounded-3xl shadow-sm border border-gray-100 relative overflow-hidden">
      <div className="relative z-10 flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
        ...
        <div className="text-center sm:text-left flex-1 min-w-0">
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-black text-gray-900 uppercase tracking-tight truncate">
            {student.names}
          </h1>
          <div className="flex flex-wrap items-center gap-2 mt-1">
            <p className="text-gray-500 font-medium text-sm sm:text-base">
              Admission No: <span className="text-brand-600 font-bold">{student.student_no}</span>
            </p>
