        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
              ...
              {settings.logo_media ? (
                <>
                  ...
                  <div>
                    ...
                    <p className="text-accent-500 text-xs font-bold leading-tight uppercase tracking-wider">
                ...
                <div className="h-16">
                  <img
                    src={Utils.getMediaUrl(settings.logo_media) || '/footer-logo.png'}
                    alt={settings.school_name || 'Registra'}
            ...
            <p className="text-white leading-relaxed mb-4 text-sm">
              A premium school management platform dedicated to syncing academic excellence,
              operational efficiency, and parent engagement.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  href="/"
                  className="text-white hover:text-accent-400 transition-colors text-sm"
                >
                  Home
                </Link>
              </li>
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <a
                href="https://facebook.com/myregistra"
                target="_blank"
                rel="noopener noreferrer"
                className="h-10 w-10 bg-white/10 hover:bg-accent-500 rounded-lg flex items-center justify-center text-white transition-all duration-300"
              >
                <Facebook size={20} />
              </a>
              <a
                href="https://instagram.com/myregistra"
                target="_blank"
                rel="noopener noreferrer"
                className="h-10 w-10 bg-white/10 hover:bg-accent-500 rounded-lg flex items-center justify-center text-white transition-all duration-300"
              >
