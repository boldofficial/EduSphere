              ...
              return (
                <button
                  ...
                  className={`w-full p-4 text-left transition-colors flex gap-3 ${
                    isActive ? 'bg-brand-50 border-l-4 border-brand-500' : 'hover:bg-gray-50'
                  }`}
                >
                  <div
                    className={`h-10 w-10 rounded-full flex items-center justify-center shrink-0 ${conv.type === 'GROUP' ? 'bg-purple-100 text-purple-600' : 'bg-brand-100 text-brand-600'}`}
                  >
                    {conv.type === 'GROUP' ? (
      ...
      <div className="flex-1 flex flex-col bg-gray-50/30">
        {activeConversation ? (
          <>
            ...
            <div className="p-4 bg-white border-b border-gray-100 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div
                  className={`h-10 w-10 rounded-full flex items-center justify-center ${activeConversation.type === 'GROUP' ? 'bg-purple-100 text-purple-600' : 'bg-brand-100 text-brand-600'}`}
                >
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-gray-400">
            ...
            <p className="text-sm">
              Or start a new one to communicate with{' '}
              {currentRole === 'admin' ? 'Staff/Parents' : 'School Admin'}
            </p>
          </div>
        )}
      </div>
        ...
        <div className="space-y-4">
          {currentRole === 'admin' ? (
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1 text-xs uppercase tracking-wider">
                  Target
                </label>
                <Select
                  value={recipientType}
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1 text-xs uppercase tracking-wider italic">
                  Recipient
                </label>
                <Select
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    ).default.post('/messages/ai-draft/', {
