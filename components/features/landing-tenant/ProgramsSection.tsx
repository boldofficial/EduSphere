...
export const ProgramsSection: React.FC<ProgramsSectionProps> = ({ settings }) => {
  const academicPrograms =
    settings.landing_academic_programs.length > 0
      ? settings.landing_academic_programs
      : [
          {
            title: 'Crèche',
            image: '/fruitful2.jpg.jpg',
            age_range: 'Ages 0 - 2',
            description: 'A safe and nurturing environment for infants and toddlers.',
          },
          {
            title: 'Pre-School',
            image: '/fruitful5.jpg.jpg',
            age_range: 'Ages 3 - 5',
            description: 'Play-based learning building foundational skills.',
          },
          {
            title: 'Primary School',
            image: '/fruitful3.jpg.jpg',
            age_range: 'Ages 6 - 11',
            description: 'A robust curriculum developing critical thinking.',
          },
        ];
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div className="max-w-xl">
            ...
            <p className="text-lg text-gray-600">
              Tailored learning stages designed to meet the developmental needs of every child.
            </p>
          </div>
          <Link
            href="/programs"
            ...
            <div key={i} className="group relative rounded-2xl overflow-hidden shadow-lg h-[400px]">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-brand-950 via-brand-950/40 to-transparent flex flex-col justify-end p-8">
                <span
                  ...
                  style={{
                    backgroundColor:
                      settings.landing_primary_color === '#1A3A5C'
                        ? '#FBBF24'
                        : settings.landing_primary_color || '#1A3A5C',
