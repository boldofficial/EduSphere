...
export const StudentAttendanceView: React.FC<StudentAttendanceViewProps> = ({
  ...
  const availableSessions = useMemo(() => {
    const sessions = new Set(
      attendance.filter((a) => a.class_id === student.class_id).map((a) => a.session)
    );
      ...
      <div>
        ...
        <div className="mt-2 flex flex-col gap-2 sm:flex-row sm:items-center">
          <p className="text-gray-500">
            View your attendance records for {targetTerm} - {targetSession}
          </p>
            ...
            {myAttendance.map((record, i) => (
              ...
              >
                <div className="flex items-center justify-between w-full">
                  ...
                  <span
                    className={`flex items-center gap-1 px-3 py-1 rounded-full text-xs font-bold uppercase ${getStatusColor(record.status)}`}
                  >
