    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid gap-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            <label className="text-sm font-bold text-gray-700 italic">
              Floating Features (Comma separated)
            </label>
            <input
              type="text"
        ...
        <div className="space-y-4">
          ...
          <div className="relative group overflow-hidden rounded-3xl aspect-[21/9] bg-gray-100 border-2 border-dashed border-gray-200 flex flex-col items-center justify-center transition-all hover:border-brand-400">
            {localSettings.landing_hero_image ? (
              <>
                <img
                  src={Utils.getMediaUrl(localSettings.landing_hero_image)}
                ...
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
                  <label className="cursor-pointer px-5 py-2.5 bg-white text-gray-900 rounded-xl font-bold text-sm shadow-lg hover:scale-105 transition-all">
                    ...
                    <input
                      ...
                      accept="image/*"
                      onChange={(e) =>
                        handleImageUpload(e, (url) => updateField('landing_hero_image', url))
                      }
                    />
                  </label>
                  <button
                    onClick={() => updateField('landing_hero_image', null)}
                    className="px-5 py-2.5 bg-red-500 text-white rounded-xl font-bold text-sm shadow-lg hover:scale-105 transition-all"
                  >
                    Remove
                  </button>
                </div>
