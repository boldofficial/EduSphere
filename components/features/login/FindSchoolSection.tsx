...
export const FindSchoolSection: React.FC<FindSchoolSectionProps> = ({
  ...
  return (
    <div
      className={`w-full max-w-4xl grid grid-cols-1 ${showSystemLogin ? 'md:grid-cols-2' : 'max-w-md'} gap-8 px-4 relative z-20`}
    >
      <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 flex flex-col justify-center border border-white/50">
        ...
        <p className="text-gray-500 mb-8 font-medium">
          Enter your school&rsquo;s unique ID or subdomain to access your portal.
        </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-100 text-center">
          ...
          <Link
            href="/onboarding"
            className="text-brand-600 hover:text-brand-700 font-bold flex items-center justify-center gap-1 group"
          >
        ...
        <div className="bg-brand-900/60 backdrop-blur-xl rounded-3xl p-8 border border-white/20 shadow-2xl flex flex-col justify-between animate-in slide-in-from-right-8 duration-500 group hover:border-brand-400/30 transition-colors">
          <div>
            ...
            <p className="text-brand-100/70 mb-8">
              Access the platform management dashboard. For Super Admins only.
            </p>
          </div>
