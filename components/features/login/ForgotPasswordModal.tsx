...
export const ForgotPasswordModal: React.FC<ForgotPasswordModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-8 animate-in zoom-in-95 fade-in duration-300"
        ...
        {!success ? (
          <>
            <div className="text-center mb-6">
              ...
              <p className="text-sm text-gray-500 mt-2">
                Enter your Student Number and registered email to reset your password.
              </p>
            </div>
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-gray-500 mb-6">
              In a real system, this password would be sent to your registered email.
            </p>
            <button
              onClick={() => {
                setSuccess(false);
