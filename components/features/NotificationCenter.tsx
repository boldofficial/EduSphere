...
import { Bell, X, Megaphone, CreditCard, Calendar, Newspaper, Circle } from 'lucide-react';
...
export const NotificationCenter: React.FC = () => {
  ...
  const notifications = useMemo(() => {
    ...
    const student = safeStudents.find(
      (s: Types.Student) => s.id === (currentUser?.student_id || safeStudents[0]?.id)
    );
    ...
    const nextExam = safeEvents.filter((e) => {
