      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">{status?.enabled ? 'Enabled' : 'Disabled'}</p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 pt-4 mt-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">{status.backup_codes_count} codes remaining</p>
            </div>
            <button
...
function TwoFactorSetupForm({
  ...
  if (!setupData) {
    return (
      <div className="text-center p-4">
        ...
        <button onClick={onCancel} className="mt-2 text-brand-600">
          Cancel
        </button>
      </div>
    );
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Enter code from app</label>
        <input
          type="text"
          value={code}
      ...
      <div className="flex gap-2">
        <button onClick={onCancel} className="flex-1 px-3 py-2 border rounded-lg hover:bg-gray-50">
          Cancel
        </button>
        <button
          onClick={verify}
