        ...
        <table className="w-full text-sm text-left">
          <thead className="bg-gray-50 text-gray-700">
            <tr>
              ...
              <th className="px-4 py-3">Class Scope</th>
          ...
          <tbody className="divide-y divide-gray-100">
            {fees
              .filter(
                (f) => f.session === settings.current_session && f.term === settings.current_term
              )
              .map((f) => {
                const clsName = f.class_id
