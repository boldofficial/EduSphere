...
const SimpleScholarshipList: React.FC = () => {
  ...
  if (isLoading)
    return <div className="text-center py-12 text-gray-500">Loading scholarships...</div>;
    ...
    <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, benefit_type: e.target.value as any })
                  }
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-brand-500 outline-none"
                >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {scholarships?.map((s) => (
          <Card
            key={s.id}
            className={`p-5 transition-all hover:shadow-md ${!s.is_active ? 'opacity-60 bg-gray-50' : ''}`}
          >
            ...
            <div className="mt-4 flex items-center justify-between">
              <div className="flex flex-col">
                <span
                  className={`text-lg font-black ${s.is_active ? 'text-brand-700' : 'text-gray-500'}`}
                >
        ...
        {scholarships?.length === 0 && !isAdding && (
          <div className="col-span-full py-12 text-center border-2 border-dashed border-gray-200 rounded-xl">
            ...
            <p className="text-gray-500 text-sm mt-1">
              Start by creating your first scholarship or fee waiver program.
            </p>
            <Button
