  ...
  return (
    ...
    >
      <div style={{ padding: '15mm', fontFamily: "'Segoe UI', Arial, sans-serif" }}>
          ...
          >
            {settings.logo_media && (
              <img
                ...
                alt="Logo"
                style={{ height: '45px', width: '45px', objectFit: 'contain', flexShrink: 0 }}
              />
            )}
            <div style={{ textAlign: 'left', minWidth: 0 }}>
              ...
              <div
                style={{ color: '#555', fontSize: '9px', lineHeight: 1.4, wordWrap: 'break-word' }}
              >
        ...
        >
          <div style={{ flex: '1 1 120px', minWidth: 0 }}>
            ...
            <p style={{ margin: '2px 0' }}>
              ...
              <span style={{ fontWeight: 600, color: '#333' }}>{payment.date}</span>
            </p>
          </div>
          <div style={{ flex: '1 1 120px', minWidth: 0, textAlign: 'right' }}>
            <p style={{ margin: '2px 0' }}>
              ...
              <span style={{ fontWeight: 600, color: '#333' }}>{payment.session}</span>
            </p>
            <p style={{ margin: '2px 0' }}>
              <span style={{ fontSize: '8px', color: '#888', textTransform: 'uppercase' }}>
                Term:
              </span>{' '}
              <span style={{ fontWeight: 600, color: '#333' }}>{payment.term}</span>
            </p>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <div style={{ flex: '0 0 auto', textAlign: 'right' }}>
              ...
              <p style={{ fontWeight: 600, color: '#333', fontSize: '11px', margin: 0 }}>
                {cls?.name || 'N/A'}
              </p>
            </div>
          </div>
        ...
        {payment.remark && (
          <div
            style={{ fontSize: '9px', color: '#666', marginBottom: '10px', fontStyle: 'italic' }}
          >
            Note: {payment.remark}
          </div>
        )}
        ...
        <div style={{ borderTop: '2px solid #1A3A5C', paddingTop: '12px', marginTop: '16px' }}>
          ...
          >
            <div style={{ textAlign: 'center', flex: '0 0 auto' }}>
              ...
              <p style={{ fontWeight: 600, fontSize: '10px', margin: 0 }}>
                {settings.head_of_school_name || 'Head of Schools'}
              </p>
              <p style={{ fontSize: '8px', color: '#666', margin: 0 }}>
                {(settings.head_teacher_label === 'Head Teacher'
                  ? 'Head of Schools'
                  : settings.head_teacher_label) || 'Head of Schools'}
              </p>
            </div>
