...
import { Loader2, Sparkles, CheckCircle, Clock, FileText } from 'lucide-react';
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2">
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                {selectedSubmission.file_url && (
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => window.open(selectedSubmission.file_url)}
                  >
            ...
            <Card className="p-6 border-brand-100 bg-brand-50/20">
              ...
              <div className="mt-8 flex justify-end gap-3 pt-6 border-t border-brand-100">
                <Button variant="ghost" onClick={() => setSelectedSubmissionId(null)}>
                  Cancel
                </Button>
                <Button
                  onClick={handleSave}
