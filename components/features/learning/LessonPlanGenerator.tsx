    ...
    <div className="p-6 space-y-8 max-w-5xl mx-auto">
      ...
      <div>
        ...
        <p className="text-gray-500 mt-1">
          Generate detailed, curriculum-aligned lesson plans with AI
        </p>
      </div>
      ...
      <Card className="p-6 space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Input
              placeholder="e.g. Students should be able to solve x² + bx + c = 0"
              value={objectives}
      ...
      {plan && (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div>
                ...
                <div className="flex gap-4 mt-2 text-sm text-gray-500">
                  <span className="flex items-center gap-1">
                    <BookOpen className="w-4 h-4" /> {plan.subject}
                  </span>
                  <span>|</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Card className="p-5">
              <h3 className="text-xs font-black text-brand-600 uppercase tracking-wider mb-3">
                🎯 Learning Objectives
              </h3>
            ...
            <Card className="p-5">
              <h3 className="text-xs font-black text-orange-600 uppercase tracking-wider mb-3">
                📦 Materials Needed
              </h3>
          ...
          {/* Lesson Flow */}
          <Card className="p-6">
            <h3 className="text-xs font-black text-purple-600 uppercase tracking-wider mb-4">
              📋 Lesson Flow
            </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Card className="p-5">
              <h3 className="text-xs font-black text-green-600 uppercase tracking-wider mb-3">
                🏠 Homework
              </h3>
