      ...
      <div className="space-y-6">
        ...
        {(paymentSettings.enable_paystack || paymentSettings.enable_flutterwave) && (
          <div className="rounded-lg border border-blue-200 bg-blue-50 px-3 py-2 text-xs text-blue-800">
            Online payment methods are enabled. Full checkout and webhook verification flow will be
          ...
          <div className="space-y-3 rounded-lg border border-gray-200 p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <Input
                ...
                placeholder={
                  paymentSettings.has_flutterwave_secret ? '********' : 'FLWSECK_TEST-...'
                }
              />
              <Input
                label="Webhook Secret"
        ...
        {(paymentSettings.enable_paystack || paymentSettings.enable_flutterwave) && (
          <div className="rounded-lg border border-gray-200 p-4 space-y-2">
            ...
            <p className="text-xs text-gray-500">
              When enabled, the ~1.5% gateway fee is added to the parent&apos;s checkout total so
              the school receives the full fee amount.
            </p>
            <label className="flex items-center gap-2 text-sm text-gray-700">
              <input
                type="checkbox"
