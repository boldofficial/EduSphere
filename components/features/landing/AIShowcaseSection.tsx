...
export const AIShowcaseSection: React.FC = () => (
  <section
    id="ai-features"
    className="py-28 bg-gradient-to-br from-gray-950 via-brand-950 to-purple-950 text-white relative overflow-hidden"
  >
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      >
        ...
        <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
          Six powerful AI modules that automate tedious tasks, surface hidden insights, and give
          your school a competitive edge — all included at no extra cost.
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
        {aiFeatures.map((feature, index) => (
          ...
          >
            <div
              className={`relative bg-white/[0.04] backdrop-blur-sm rounded-3xl p-8 border border-white/10 hover:border-white/20 transition-all duration-500 hover:-translate-y-1 hover:shadow-2xl ${feature.glow} h-full`}
            >
              {/* Glow effect on hover */}
              <div
                className={`absolute -inset-px rounded-3xl bg-gradient-to-br ${feature.color} opacity-0 group-hover:opacity-10 transition-opacity duration-500 blur-sm`}
              />

              <div className="relative z-10">
                {/* Icon */}
                <div
                  className={`w-14 h-14 bg-gradient-to-br ${feature.color} rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300`}
                >
