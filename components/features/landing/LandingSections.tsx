...
const testimonials = [
  {
    quote:
      'Registra has revolutionized how we manage our school. The automation features have saved us countless hours, and our parents love the transparency.',
    author: 'Mrs. Adebayo',
    role: 'Principal',
  ...
  {
    quote:
      "The financial management module is incredible. We've eliminated billing errors and improved our cash flow significantly.",
    author: 'Mr. Okon',
  ...
  {
    quote:
      'Our teachers love the LMS features, and student performance has improved dramatically with the analytics tools.',
    author: 'Dr. Ibrahim',
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Simply click the 'Start Free Trial' button, set up your school details, and our onboarding team will reach out to guide you through the next steps.",
  },
];
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Comprehensive modules designed to streamline every aspect of school management, from
        ...
        {features.map((feature, index) => (
          ...
          >
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-100/50 h-full relative overflow-hidden">
              <div
                className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br ${feature.color} opacity-5 rounded-bl-full group-hover:scale-125 transition-transform duration-700`}
              />
              <div
                className={`w-16 h-16 bg-gradient-to-br ${feature.color} rounded-2xl flex items-center justify-center mb-6 text-white shadow-lg group-hover:scale-110 transition-transform duration-300 relative z-10`}
              >
  ...
  <section id="about" className="py-24 bg-white">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Our streamlined onboarding process gets your school up and running quickly, with expert
        ...
        {steps.map((step, index) => (
          ...
          >
            <div className="relative mb-8">
              ...
              {index < 3 && (
                <div
                  className="hidden md:block absolute top-10 left-full w-full h-0.5 bg-gradient-to-r from-brand-200 to-purple-200 -translate-y-1/2"
  ...
  >
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      >
        ...
        <h2 className="text-4xl md:text-5xl font-black mb-6">Trusted by Leading Schools</h2>
  ...
  <section id="faq" className="py-24 bg-gray-50">
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-6">Got Questions?</h2>
        <p className="text-xl text-gray-600">Find answers to common questions about Registra.</p>
      </motion.div>
