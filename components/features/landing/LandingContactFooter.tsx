    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Join hundreds of schools already using Registra. Let&apos;s discuss how we can help your
          institution thrive.
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            The complete school management platform for modern Nigerian educational institutions.
            Streamlining administration, enhancing learning, and driving academic excellence.
          </p>
          <div className="flex gap-4">
            {[
              { icon: Facebook, href: 'https://facebook.com/myregistra' },
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-gray-400">
            ...
            <li>
              <Link href="/success-stories" className="hover:text-brand-400 transition-colors">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-gray-400">
            ...
            <li>
              <Link href="/careers" className="hover:text-brand-400 transition-colors">
                Careers
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/terms-of-service" className="hover:text-brand-400 transition-colors">
                Terms of Service
              </Link>
            </li>
          </ul>
