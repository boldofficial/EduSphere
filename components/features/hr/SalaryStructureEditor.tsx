...
export const SalaryStructureEditor: React.FC<SalaryStructureEditorProps> = ({
  ...
  const renderItemRow = (item: StructureItem, idx: number, type: 'allowance' | 'deduction') => (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  {allowances.map((item, idx) => renderItemRow(item, idx, 'allowance'))}
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  {deductions.map((item, idx) => renderItemRow(item, idx, 'deduction'))}
