...
interface EventModalsProps {
  ...
  formState: {
    ...
    eventType: Types.SchoolEvent['event_type'];
    setEventType: (v: Types.SchoolEvent['event_type']) => void;
    targetAudience: Types.SchoolEvent['target_audience'];
    setTargetAudience: (v: Types.SchoolEvent['target_audience']) => void;
        ...
        {viewingEvent && (
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <span
                className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-sm font-medium ${getEventTypeColor(viewingEvent.event_type)}`}
              >
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Select
              ...
              onChange={(e) => formState.setEventType(e.target.value as any)}
            >
            ...
            <Select
              ...
              onChange={(e) => formState.setTargetAudience(e.target.value as any)}
            >
          ...
          {(formState.targetAudience === 'students' || formState.targetAudience === 'parents') && (
            <Select
              ...
              onChange={(e) => formState.setSelectedClassId(e.target.value)}
            >
              <option value="">
                All {formState.targetAudience === 'students' ? 'Students' : 'Parents'}
              </option>
              {classes.map((cls: any) => (
