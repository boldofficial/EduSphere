...
import { X, Send, User, Type, Globe, ShieldCheck, Zap, AlertCircle } from 'lucide-react';
...
export const SendIndividualEmailModal: React.FC<SendIndividualEmailModalProps> = ({
  isOpen,
  onClose,
}) => {
