...
export const SupportTicketsTab: React.FC<SupportTicketsTabProps> = ({
  ...
  const handleRespond = async () => {
    ...
    try {
      ...
      const updatedTicket = {
        ...selectedTicket,
        responses: [...selectedTicket.responses, res.data],
      };
  ...
  return (
    <div className="flex h-[800px] gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      {/* Sidebar: Ticket List */}
      <div
        className={`flex-col bg-white rounded-[40px] shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden ${selectedTicket ? 'hidden lg:flex w-1/3' : 'flex w-full'}`}
      >
      ...
      <div
        className={`flex-1 bg-white rounded-[40px] shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden flex flex-col ${selectedTicket ? 'flex' : 'hidden lg:flex items-center justify-center'}`}
      >
        {selectedTicket ? (
          <>
            {/* Header */}
          ...
          <div className="text-center p-12 space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 font-bold uppercase tracking-widest mt-1">
                Review school technical requests
              </p>
            </div>
          </div>
        )}
