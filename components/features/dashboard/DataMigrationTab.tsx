      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500">
            Bulk import student records using standardized CSV templates.
          </p>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
          ...
          <p className="text-gray-600 mb-6 text-sm">
            ...
            <span className="text-xs text-amber-600 font-medium">
              Note: Ensure &lsquo;Class Name&rsquo; matches exactly with classes in the system
              (e.g., &ldquo;JSS 1&rdquo;).
            </span>
          </p>
        ...
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
          ...
          <div className="border-2 border-dashed border-gray-200 rounded-xl p-8 flex flex-col items-center justify-center text-center hover:border-indigo-300 transition-colors bg-gray-50/50 group">
            <FileSpreadsheet
              className="text-gray-400 mb-4 group-hover:text-indigo-400 transition-colors"
              size={40}
            />
            ...
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
              ...
              <div className="max-h-96 overflow-y-auto">
                <table className="w-full text-sm text-left">
                  ...
                  <tbody>
                    {results.errors.map((err: ImportError, idx: number) => (
