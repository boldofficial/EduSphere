...
export const EmailMarketingTab: React.FC = () => {
  ...
  const [stats, setStats] = useState<{
    ...
    success_rate: number;
  }>({ total_sent: 0, total_failed: 0, total_emails: 0, campaign_count: 0, success_rate: 0 });
                    ...
                    <div className="space-y-4 mb-6">
                      ...
                      <div className="flex justify-between items-center text-[10px] font-bold text-gray-500">
                        ...
                        <span className="flex items-center gap-1">
                          <Clock size={10} /> {new Date(campaign.created_at).toLocaleDateString()}
                        </span>
                      </div>
                    </div>
                  ...
                  <tbody className="divide-y divide-gray-50">
                    {logs.map((log) => (
                      <tr key={log.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4">
                          <div className="text-xs font-bold text-gray-600 line-clamp-1">
                            {log.subject}
                          </div>
                        </td>
                        <td className="px-6 py-4">
