...
export const MessageInboxWidget: React.FC<MessageInboxWidgetProps> = ({
  ...
  return (
    <>
            ...
            return (
              ...
              >
                <div className="flex items-start gap-3">
                  <div
                    className={`h-8 w-8 rounded-full flex items-center justify-center shrink-0 ${!isMe ? 'bg-brand-100 text-brand-600' : 'bg-gray-100 text-gray-500'}`}
                  >
      ...
      {/* Message View Modal */}
      <Modal isOpen={!!viewingMessage} onClose={closeModal} title="Message Details" size="sm">
        {viewingMessage && (
          <div className="space-y-4">
            ...
            {canReply(viewingMessage) && (
              <>
                {!isReplyMode ? (
                  <Button variant="outline" onClick={() => setIsReplyMode(true)} className="w-full">
