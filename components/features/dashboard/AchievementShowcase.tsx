  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {achievements.map((item: any) => (
        <Card
          key={item.id}
          className="p-5 border-none bg-gradient-to-br from-white to-gray-50/30 rounded-[24px] shadow-sm hover:shadow-md transition-all group overflow-hidden relative"
        >
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-[10px] font-bold text-gray-400 capitalize">
                  {Utils.formatDate(item.date_achieved, 'MMM yyyy')}
                </span>
              </div>
