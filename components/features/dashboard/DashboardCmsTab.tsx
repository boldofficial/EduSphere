      ...
      <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl">
            ...
            />
            <label htmlFor="showStats" className="font-medium text-gray-700">
      ...
      <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 lg:col-span-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {editedSettings.landing_core_values?.map((value, index) => (
            <div
              key={index}
              className="p-4 bg-gray-50 rounded-2xl relative border border-gray-100 group"
            >
              <button
      ...
      <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 lg:col-span-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {editedSettings.landing_academic_programs?.map((program, index) => (
            <div
              key={index}
              className="bg-gray-50 rounded-2xl overflow-hidden border border-gray-100 group relative"
            >
              <button
              ...
              <div className="p-4 space-y-3">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (file) {
                          ...
                          reader.onloadend = () =>
                            handleAcademicProgramChange(index, 'image', reader.result as string);
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleAcademicProgramChange(index, 'age_range', e.target.value)
                    }
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      handleAcademicProgramChange(index, 'description', e.target.value)
                    }
                    className="w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-brand-500 focus:border-transparent resize-none bg-white font-medium"
                    rows={3}
