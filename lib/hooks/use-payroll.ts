...
export function useSalaryAllowances() {
  return useQuery({
    ...
    queryFn: async () => {
      const res =
        await apiClient.get<Types.PaginatedResponse<Types.SalaryAllowance>>(
...
export function useCreateAllowance() {
  ...
  return useMutation({
    mutationFn: (data: Partial<Types.SalaryAllowance>) =>
      apiClient.post('hr/salary-allowances/', data),
...
export function useSalaryDeductions() {
  return useQuery({
    ...
    queryFn: async () => {
      const res =
        await apiClient.get<Types.PaginatedResponse<Types.SalaryDeduction>>(
...
export function useCreateDeduction() {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: (data: Partial<Types.SalaryDeduction>) =>
      apiClient.post('hr/salary-deductions/', data),
...
export function useStaffSalaryStructure(staffId: string | number) {
  return useQuery({
    ...
    queryFn: async () => {
      const res = await apiClient.get<Types.StaffSalaryStructure>(
        `hr/salary-structures/by_staff/?staff_id=${staffId}`
      );
      return res.data;
    },
    enabled: !!staffId,
...
export function useUpdateSalaryStructure() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      id: string | number;
      data: Partial<Types.StaffSalaryStructure>;
