...
export function hasMinimumRole(minimumRole: UserRole, userRole: UserRole | null): boolean {
...
export async function withRoleGuard(requiredRoles: UserRole[], redirectTo: string = '/login') {
